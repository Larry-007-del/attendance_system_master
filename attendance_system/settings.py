...
__secret_key = os.environ.get('DJANGO_SECRET_KEY')
...
INSTALLED_APPS = [
    ...
    'anymail',  # Anymail for handling Resend emails bypass
...
# - Development/tests default: sync (deterministic behavior)
SEND_WELCOME_EMAIL_ASYNC = os.environ.get(
